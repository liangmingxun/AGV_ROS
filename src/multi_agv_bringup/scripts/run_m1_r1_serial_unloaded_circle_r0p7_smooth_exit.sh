...
export FORMAL_RUNTIME_CONFIG=src/multi_agv_bringup/config/formal_serial_m1_r1_circle_r0p7_smooth_exit_runtime.yaml
...
export FORMAL_RUN_TIMEOUT_SECONDS=95
export FORMAL_EXPERIMENT_ID=m1_r1_circle_r0p7_cw_smooth_exit_serial
export FORMAL_RUN_PREFIX=m1_r1_circle_r0p7_cw_smooth_exit
