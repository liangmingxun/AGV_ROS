...
export FORMAL_EXPERIMENT_ID="${FORMAL_EXPERIMENT_ID:-m1_r1_circle_r0p7_cw_short_arc_serial}"
export FORMAL_RUN_PREFIX="${FORMAL_RUN_PREFIX:-m1_r1_circle_r0p7_cw_short_arc}"
