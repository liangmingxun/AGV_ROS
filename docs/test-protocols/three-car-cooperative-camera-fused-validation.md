...
启动脚本校验冻结配置 SHA-256：
`02c72f5c422f92891f431ecb81699abd826f30b0df4ecf5a64ecc4f21ad7b0d3`；
每次 manifest 还记录路径和支撑几何文件哈希。

代表性完整结果为 `20260902_133116_s`：正式评价窗口最大队间距离漂移
27.5 mm、最大相对航向误差 4.62 deg，状态为 PASS。偶发融合话题瞬态延迟
单独记为通信可用性事件，不改变本配置的控制性能身份。
...
2. S 路径门：0.05 m/s、1.00 m；验证正负转向、编队保持和三车差异化参数。
